/* @ts-self-types="./faf_wasm_gen.d.ts" */
...
export function generate_faf(repo_name, owner, description, readme, dependency_file, language) {
    ...
    try {
        ...
        const ptr0 = passStringToWasm0(repo_name, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        ...
        var ptr3 = isLikeNone(readme) ? 0 : passStringToWasm0(readme, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        var len3 = WASM_VECTOR_LEN;
        var ptr4 = isLikeNone(dependency_file) ? 0 : passStringToWasm0(dependency_file, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        var len4 = WASM_VECTOR_LEN;
        var ptr5 = isLikeNone(language) ? 0 : passStringToWasm0(language, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        var len5 = WASM_VECTOR_LEN;
        wasm.generate_faf(retptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4, ptr5, len5);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('faf_wasm_gen_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
